...
## Project Overview
Automated AI newsletter generator that processes the ZenML LLMOps dataset from Hugging Face and generates weekly newsletters in Markdown format for Odido employees.
